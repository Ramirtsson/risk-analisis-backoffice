...
class UpdateDetailFractionRequest extends FormRequest
{
    /**
    ...
    public function messages(){
        return [
            ...
            "fraction_id.required" => "El campo fraccion arancelaria es obligatorio",
            "fraction_id.exists" => "El valor ingresado no es permitido",
        ];
    }
