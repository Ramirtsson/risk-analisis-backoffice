...
class UpdateCustomersRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mail_1' => 'nullable|email|max:100',
            'mail_2' => 'nullable|email|max:100',
    ...
    public function messages(): array
    {
        return [
            ...
            'social_reason.max' => 'Razón social no puede tener más de 150 caracteres.',
            ...
            'phone_1.max' => 'Teléfono 1 no puede tener más de 25 caracteres.',
            'phone_2.max' => 'Teléfono 2 no puede tener más de 25 caracteres.',
            'mail_1.email' => 'Correo 1 debe ser una dirección de correo válida.',
            'mail_1.max' => 'Correo 1 no puede tener más de 100 caracteres.',
            'mail_2.email' => 'Correo 2 debe ser una dirección de correo válida.',
            'mail_2.max' => 'Correo 2 no puede tener más de 100 caracteres.',
